/* The last two letters in vowels (అంఅః) are combination of two unicodes (అ + ం = అం) and similarly (అ + ః = అః) */

const vowels = "అఆఇఈఉఊఎఏఐఒఓఔఅంఅః".split('');
const extra = "్"
const basic = "కఖగఘఙచఛజఝఞటఠడఢణతథదధనపఫబభమయరలవశషసహళఱ".split('')
const partialsStr= 'కకాకికీకుకూకెకేకైకొకోకౌకంకః';
/*
